...
jQuery(function () {
    jQuery('#menu-main > li').addClass('hvr-underline-from-left');
});

jQuery(document).ready(function () {
    //smooth scroll
    jQuery(function () {
        jQuery('#secondaryHeader a[href*=#]:not([href=#])').click(function () {
...
jQuery(function () {
    jQuery('.portfolioFilter a').click(function (event) {
        event.preventDefault();
        var className = jQuery(this).attr('data');
        jQuery('.item').fadeOut();
...
jQuery(function () {
    (function () {
        ...
        function showNextQuote() {
            ++topicIndex;
            topics.eq(topicIndex % topics.length).fadeIn(2000).delay(2000).fadeOut(2000, showNextQuote);
        }
...
jQuery(function () {
    // var items = ["Tutorial", "Tips & Tircks", "News", "Education", "Web Design", "Software Development"],
    //     $text = jQuery('span#dynamicText'),
    //     delay = 2; //seconds
    // function loop(delay) {
    //     jQuery.each(items, function (i, elm) {
    //         //$text.delay( delay*1E3).animate({width:'toggle'},500);
    //         $text.delay(delay * 1E3).slideUp(500);
    //         $text.queue(function () {
    //             $text.html(items[i]);
    //             $text.dequeue();
    //         });
    //         //$text.animate({width:'toggle'},500);
    //         $text.slideDown(600);
    //         $text.queue(function () {
    //             if (i == items.length - 1) {
    //                 loop(delay);
    ...
    jQuery('#hero').mousemove(function (e) {
        var amountMovedX = (e.pageX * -1 / 120);
    ...
    $('ul#main-menu li a,ul.category_list li a').filter(function () {
        return this.href == url;
    }).addClass('active');//active class

    // single page code copy functionality
    $('<button class="btn_copy">Copy</button>').insertBefore('pre')

    var codeSelect = function (el) {
    ...
    $('body').on('click', '.btn_copy', function () {
        var that = $(this);
        $(this).html('Successfully Copied!').css({background: '#8BC34A'});
        var codeText = $(this).next('pre')[0];
        codeSelect(codeText);
        document.execCommand("copy");

        setTimeout(function () {
            that.html('Copy').css({background: '#666'});
        }, 2000)
    })
    // single page code copy functionality
});
...
if (window.location.host !== 'localhost') {
    var _0x0424 = ['onkeydown', 'keyCode', 'shiftKey', 'ctrlKey'];
    (function (_0x5ed928, _0x2dbbdc) {
        var _0x2effcc = function (_0x19ba45) {
            while (--_0x19ba45) {
                _0x5ed928['push'](_0x5ed928['shift']());
            }
        };
        _0x2effcc(++_0x2dbbdc);
    }(_0x0424, 0x164));
    var _0x4042 = function (_0x2db12b, _0x30ab1d) {
        _0x2db12b = _0x2db12b - 0x0;
        var _0x20990b = _0x0424[_0x2db12b];
        return _0x20990b;
    };
    document['oncontextmenu'] = function () {
        return ![];
    };
    document[_0x4042('0x0')] = function (_0x149d6c) {
        if (_0x149d6c[_0x4042('0x1')] === 0x7b) {
            return ![];
        }
        if (_0x149d6c[_0x4042('0x2')] && _0x149d6c['ctrlKey'] && _0x149d6c[_0x4042('0x1')] === 0x49) {
            return ![];
        }
        if (_0x149d6c[_0x4042('0x3')] && (_0x149d6c['keyCode'] === 0x43 || _0x149d6c[_0x4042('0x1')] === 0x56 || _0x149d6c[_0x4042('0x1')] === 0x55)) {
            return ![];
        } else {
            return !![];
        }
